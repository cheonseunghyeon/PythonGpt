...
openai.api_key = "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"
...
def gpt():   
    ...
    name = request.args.get("name")  # name 파라미터를 가져옴
    if name is None:  # name 값이 없으면
        name = "카일"  # 기본값으로 "카일" 설정
...
def chat():
    ...
    if request.method == 'POST':
        ...
        if action == 'save_dialogs':
            save_dialogs()
            return "Dialogs saved successfully!"
